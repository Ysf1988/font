	function pagePostMessage() {
			...
			var homePage = "<data:blog.homepageUrl/>";
			var searchpage ="/search/label/";	
		
	document.write('<div id="separator3"></div>'),
	document.write('<div class="separator1"><h2>القصة : </h2><span>' + stry1 + '</span></div>'),
	document.write('<div class="separator1"><span>' + stry2 +'</span></div>'),	
	document.write('<div id="separator4"></div>'),
	...
	document.getElementById("separator4").innerHTML ='<div class="tags"><p><span>الجودة :</span><a expr:href="'+ homePage +''+ searchpage +''+ quality +'">'+ quality +'</a></p><p><span>القسم :</span> <a expr:href="data:label.url"><data:label.name/></a></p><p><span>السنة :</span><a expr:href="'+ homePage +''+ searchpage +''+ year + '">'+ year +'</a></p><p><span>النوع :</span><a expr:href="'+ homePage +''+ searchpage +''+ types +'">'+ types +'</a><a class="imdbICon" target="_blank" href="'+ imdb +'"><i class="fa fa-film"></i> IMDB</a></div><div class="modalTrailer" style="display: none"><div class="modalTrailerClose" autoplay="autoplay"></div><iframe width="640" height="360" src="'+ yutb +'" frameborder="0" gesture="media" allowfullscreen="" autoplay="autoplay"></iframe></div><a href="Javascript:void(0);" class="showTrailer"><i class="fa fa-youtube-play"></i> مشاهدة الاعلان</a>';
